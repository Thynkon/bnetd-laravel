<div class="grow snap-center min-w-max w-auto px-4 py-2 bg-white rounded shadow">
    ...
    <div class="w-full flex py-2">
        ...
        <div>
            <span
                class="block font-bold">{{ Carbon\CarbonInterval::seconds($options['bantime'])->cascade()->forHumans() }}</span>
