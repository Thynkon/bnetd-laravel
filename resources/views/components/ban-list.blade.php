  ...
  <div class="bg-white">
    <div>
      ...
      <main class="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative z-10 flex items-baseline justify-end pt-4 sm:pt-6 lg:pt-8 pb-6 border-b border-gray-200">
          <div class="flex items-center">
            <div class="relative inline-block text-left">
              ...
              <div id="sort-list"
                ...
                <div class="py-1" role="none">
                  ...
                  -->
                  <a href="{{ route('bans.sort', ['param' => 'country']) }}" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                    id="menu-item-0">Country</a>

                  <a href="{{ route('bans.sort', ['param' => 'jail']) }}" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                    id="menu-item-0">Jail</a>

                  <a href="{{ route('bans.sort', ['param' => 'port']) }}" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                    id="menu-item-0">Port</a>

                  <a href="{{ route('bans.sort', ['param' => 'nbr_bans', 'type' => 'desc']) }}" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                    id="menu-item-0">Number of bans</a>

                  <a href="{{ route('bans.sort', ['param' => 'last_ban', 'type' => 'desc']) }}" class="font-medium text-gray-900 block px-4 py-2 text-sm" role="menuitem" tabindex="-1"
                    id="menu-item-0">Last ban</a>
                </div>
              </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-auto">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ $log->jail }}</div>
                          </td>
                          <td class="px-6 py-4 whitespace-nowrap">
                            <span
